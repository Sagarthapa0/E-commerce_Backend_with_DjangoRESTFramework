...
from .views import OrderCreateView,OrderDeleteView,OrderListView,OrderRetrieveView,OrderUpdateView,ProductPurchasedByBuyer,DeliveryCreateAPIView,DeliveryRetrieveUpdateDestroyAPIView,DeliveryListView,UserOrderList
...
urlpatterns=[
    ...
    path("byuser/<int:pk>/",UserOrderList.as_view(),name='user-order-list'),
